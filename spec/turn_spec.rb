...
describe Turn do
  ...
  let(:options) { {"player_name" => "Ivan", "player_shape" => :rock, "opponent_shape" => :scissors} }

  describe '#player_name' do
    it 'returns player name' do
      expect(turn.player_name).to eq 'Ivan'
    end
  end
  ...
  context 'end game' do
    ...
    let(:lose_options) { {"player_name" => "Ivan", "player_shape" => :rock, "opponent_shape" => :paper} }
    let(:draw_options) { {"player_name" => "Ivan", "player_shape" => :rock, "opponent_shape" => :rock} }
